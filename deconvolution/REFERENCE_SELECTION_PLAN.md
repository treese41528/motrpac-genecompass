...
| TESTES | [OMIX767] (C+E7W, staged) | normal-T; **ingest** 5,850 cells | scRNA · SD | NEEDS-ONLINE-DATA | **Chosen** — only rat testis scRNA; **pool C+E7W normal-T arms** (Geyu) = 5,850 cells. Heavy ambient + thin somatics → differential. |
