...
- **Ours:** muscle is responsive, but the cell-type breakdown is informative — the **stroma responds as strongly as the parenchyma**: SKMGN muscle fibroblasts 367 / endothelial 251 / **skeletal-muscle cells 227**; SKMVL muscle fibroblasts 281 / **skeletal-muscle cells 261** / endothelial 257 / fibers 255. Composition confounds fire on the stroma (SKMGN fibroblasts/endothelial `frac_week_p≈0.02`, SKMVL endothelial 0.002) — angiogenic/remodelling fraction shifts. **The canonical mito/HSP transcript controls are weak even in bulk muscle** (§4a) — MoTrPAC's muscle mito story is largely protein/PTM-level. **Reference fix adopted:** SKMVL was over-split; merging the two muscle-parenchyma labels improves bulk-mover recovery 50%/41% → **57%**.
